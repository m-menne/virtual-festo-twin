...
// Function to write data using SPI-bit-banging
// Parameters
// *port 			- Pointer to the port
// *pSPIWriteBuf 	- Array that contains the data to be written
// nNumBytes		- Number of Bytes to be written
// nCS 				- Chip Select to be used
...
// Funtion to set the dac channel
// Parameters:
// value 			- Data to be written
// channel			- Channel the data should be written to
